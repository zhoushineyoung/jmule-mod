...
public class SharedTab extends MainTab {
	...
	private void removeSelectedDir() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), _._("mainwindow.sharedtab.confirm_remove_shared_dir_title"), 
	...
	private void clearDirList() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), _._("mainwindow.sharedtab.confirm_clear_dir_list_title"), 
	...
	private void removeFromDisk() {
		if (!Utils.showConfirmMessage(tab_content.getShell(), _._("mainwindow.sharedtab.confirm_remove_from_disk_title"), 
